        ...
        <div>
            ...
            <div class="login-signupbox">
                <div class="login-signupform">
                    ...
                    <form action="user/home" method="post" id="user-login" name="loginForm" onsubmit="return validateLoginForm()">
            ...
            <p class="forget_pwd"><a href="index.php?url=user/passwordReset">Forgot password?</a></p>
            <p class="link-to-go-signup"><a href="index.php?url=customer/signup">Create Account? SignUp</a></p>
        </div>

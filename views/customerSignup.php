    ...
    <div id="container">
            ...
            <div class="login-signupbox">
                <div class="login-signupform">
                    ...
                    <h2 class="login-signupheader">Signup</h2>

                    <form action="customer/signup" method="post" id="customer-signup">
                        ...
                        <input class="input-box" id="signup-pwd" type="password" name="pwd" autofocus placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                        <br>
...
<script src="content/js/customerSignup.js"></script>
